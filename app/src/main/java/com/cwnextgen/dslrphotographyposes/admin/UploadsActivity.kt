package com.cwnextgen.dslrphotographyposes.admin
...
import com.cwnextgen.dslrphotographyposes.databinding.ActivityUploadsBinding
...
import com.cwnextgen.dslrphotographyposes.utils.auth
import com.cwnextgen.dslrphotographyposes.utils.firestore
import com.cwnextgen.dslrphotographyposes.utils.generateUUID
...
//            }
    ...
    private fun uploadImageToFirebaseStorage(imageUri: Uri?) {
        ...
        if (imageUri != null) {
            ...
            val imageRef = storageRef.child("appImages/${generateUUID()}.jpg")
            ...
            imageRef.putFile(imageUri).addOnSuccessListener { taskSnapshot ->
                ...
                imageRef.downloadUrl.addOnSuccessListener { downloadUri ->
                    ...
                    val imagesModel = ImagesModel(generateUUID(), imageUrl, category.id.toString())
                    saveData(imagesModel)
                }
    ...
    private fun saveData(imagesModel: ImagesModel) {
        firestore().collection(category.id.toString()).document(imagesModel.id).set(imagesModel)
